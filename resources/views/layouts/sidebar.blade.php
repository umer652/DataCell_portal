        ...
        <ul class="space-y-2">
            <li>
                <a href="{{ route('dashboard') }}"
                    class="nav-link ajax-link flex items-center p-2 rounded hover:bg-blue-500 hover:text-white text-gray-700" 
                    data-route="dashboard">
                    <i class="fas fa-tachometer-alt mr-2"></i> Student Management
                </a>
            </li>
            {{-- <li>
                <a href="{{ route('student.index') }}"
                    class="nav-link ajax-link flex items-center p-2 rounded hover:bg-blue-500 hover:text-white text-gray-700" 
                    data-route="student.index">
            ...
            <li>
                <a href="{{ route('course-prerequisite.index') }}"
                    class="nav-link ajax-link flex items-center p-2 rounded hover:bg-blue-500 hover:text-white text-gray-700" 
                    data-route="course-prerequisite.index">
